        ...
        <div class="container"> <!-- content start -->
            <div class="bg-box-resep-fav">
                ...
                <?php if ($this->Products->getProduct( $favorited[1]['product_id'])->media) { ?>
                    <img class="sub-pasta sub-pasta-info-resep" width="50px" src="<?php echo base_url('uploads/products/'.$this->Products->getProduct($favorited[1]['product_id'])->media);?>" alt="<?php echo $favorited[1]['subject'];?>p">
                <?php } ?>
        ...
        <div class="list-resep">
            ...
            <div class="cara-membuat2">
                <div class="bg-board board2">						
                    ...
                    <div class="carousel slide food-service-carousel list-resep-board test" data-ride="carousel" id="quote-carousel">

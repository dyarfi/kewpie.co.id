              ...
              <div class="thumbnail">
                <img src="<?php echo base_url('uploads/news/thumb__288x173'.$row['media']);?>" alt="">
                  <div class="caption">
					...
					<a href="<?php echo base_url('read/news/detail/'.$row['url']);?>" class="text-danger" title="<?php echo $row['subject'];?>" role="button"><strong>(<?php echo $this->lang->line('read_more');?>)</strong></a>
					</div>
                </div>
              </div>
            </div>

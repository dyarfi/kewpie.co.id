...
// Model Class Object for ProductRecipeImages
class ProductRecipeImages Extends CI_Model {
    
	// Table name for this model
	protected $table = 'product_recipe_images';
    ...
    public function getAllImageByRecipe($field_id=null){
	    $data = array();
        if ($field_id) {
